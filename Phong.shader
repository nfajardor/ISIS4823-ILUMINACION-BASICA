...
{
  Properties {
        _Color ("Color", Color) = (1, 0, 0, 1) //The color of our object
        _Tex ("Pattern", 2D) = "white" {} //Optional texture

        _Shininess ("Shininess", Float) = 1 //Shininess
        _SpecColor ("Specular Color", Color) = (1, 0, 0, 1) //Specular highlights color
    }
    SubShader {
